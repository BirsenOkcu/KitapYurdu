...
public class ProductPage {
    ...
    public void selectProduct() {
        ...
        methods.waitBySeconds(1);
        methods.sendKeys(By.id("address-lastname-title"), "Okçu");
        methods.waitBySeconds(1);
        methods.selectByText(By.cssSelector("#address-zone-id"), "İstanbul");
        methods.waitBySeconds(1);
        methods.selectByText(By.cssSelector("#address-county-id"), "ŞİŞLİ");
        methods.waitBySeconds(1);
        ...
        methods.click(By.id("button-checkout-continue"));
        methods.waitBySeconds(4);
        methods.sendKeys(By.id("credit-card-owner"), "Birsen Okçu");
